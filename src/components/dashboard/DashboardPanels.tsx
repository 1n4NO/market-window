  ...
  return (
    <Card className="flex h-[228px] flex-col p-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-[11px] font-semibold uppercase tracking-[0.11em] text-[color:var(--mw-text-muted)]">UPCOMING OPENS</p>
      </div>

      {openingTransitions.length > 0 ? (
        <ol className="mt-3 divide-y divide-[rgba(255,255,255,0.04)]">
  ...
  return (
    <Card className="flex h-[228px] flex-col p-4">
      <div className="flex items-center gap-2">
        <p className="text-[11px] font-semibold uppercase tracking-[0.11em] text-[color:var(--mw-text-muted)]">MARKET SUMMARY</p>
...
export function QuickLinksPanel({
  ...
  return (
    <Card className="flex h-[228px] flex-col p-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-[11px] font-semibold uppercase tracking-[0.11em] text-[color:var(--mw-text-muted)]">QUICK LINKS</p>
      </div>
      ...
      <div className="mt-3 grid grid-cols-4 gap-2.5">
        {visibleLinks.map((link) => (
          <a
            key={link.id}
            className="group flex min-w-0 flex-col items-center gap-1 rounded-[14px] px-1 py-2 text-center transition hover:bg-white/[0.03] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--mw-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--mw-page)]"
            href={link.url}
          >
            <span
              aria-hidden="true"
              className="flex h-[60px] w-[60px] shrink-0 items-center justify-center rounded-[14px] border border-[color:rgba(147,166,197,0.12)] bg-[color:var(--mw-panel-inset)] text-[11px] font-semibold uppercase tracking-[0.14em] text-[color:var(--mw-text)] shadow-[var(--mw-shadow-inset)]"
            >
              {getQuickLinkMark(link)}
            </span>
            <span className="w-full truncate text-[12.5px] font-medium leading-4 text-[color:var(--mw-text-secondary)]">
              {link.label}
            </span>
          </a>
        ))}
